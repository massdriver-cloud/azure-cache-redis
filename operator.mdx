...
We disable the non-SSL port (6379) by default. The SSL port (6380) is open. You can enable the non-SSL port if you need to, but we recommend against it as it is less secure.
